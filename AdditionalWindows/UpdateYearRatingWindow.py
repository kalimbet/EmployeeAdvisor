...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_ratingForYear = tk.Label(self, text='Rating for year ')
        label_ratingForYear.place(x=50, y=170)
        ...
        self.entry_rating_for_year = ttk.Entry(self)
        self.entry_rating_for_year.place(x=200, y=170)
        ...
        self.btn_ok.bind('<Button-1>', lambda event: self.view.tab_fifth_update_record(self.entry_from_date.get(),
                                                                                  self.entry_until_date.get(),
                                                                                  self.entry_time_seconds_rest.get(),
                                                                                  self.entry_time_seconds_work.get(),
                                                                                  self.entry_rating_for_year.get()))
